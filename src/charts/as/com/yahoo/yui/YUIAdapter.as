package com.yahoo.yui
{
    ...
    //--------------------------------------
        ...
        /**
         * Sends a log message to the Firebug.
         */
        public function fb(message:Object, category:String = null):void
        {
            if(message == null) message = "";
            this.dispatchEventToJavaScript({type: "fb", message: message, category: category});
        }
