package com.yahoo.astra.fl.charts
{
    ...
    //--------------------------------------
        ...
        /**
         * @private
         * Storage for the isBeingChanged property (during drag and drop operation).
         */
        private var _isBeingChanged:Boolean = false;

        public function get isBeingChanged():Boolean
        {
            return this._isBeingChanged;
        }

        public function set isBeingChanged(value:Boolean):void
        {
        ...
        /**
         * @private
         * Storage for the temporaryValue property (series item temporaryValue value during drag and drop operation).
         */
        private var _temporaryValue:Number = 0;

        public function get temporaryValue():Number
        {
            return this._temporaryValue;
        }

        public function set temporaryValue(value:Number):void
        {
    ...
    //--------------------------------------
         ...
         * Storage for the dataTipFunction property.
         */
        private var _temporaryValueTipFunction:Function = defaultDataTipFunction;
         ...
         * signature:
         *
         * <p><code>function temporaryValueTipFunction(item:Object, index:int, series:ISeries, value:Number):String</code></p>
         */
        public function get temporaryValueTipFunction():Function
        {
            return this._temporaryValueTipFunction;
        }

        /**
         * @private
         */
        public function set temporaryValueTipFunction(value:Function):void
        {
            this._temporaryValueTipFunction = value;
        }
    ...
    //--------------------------------------
        ...
        public function getInfo():Object
        {
            var results:Object = {
                ...
                contentPadding: this.getStyleValue("contentPadding")
            };
    ...
    //--------------------------------------
         ...
         * @private
         */
        protected function defaultDataTipFunction(item:Object, index:int, series:ISeries, value:Number=0):String
        {
         ...
         * Passes data to the data tip.
         */
        protected function refreshTemporaryValueTip():void
        {
            var item:Object = this._lastDataTipRenderer.data;
            var series:ISeries = this._lastDataTipRenderer.series;
            var index:int = series.itemRendererToIndex(this._lastDataTipRenderer);
            ...
            var dataTipText:String = "";
            if(this.temporaryValueTipFunction != null)
            {
                dataTipText = this.temporaryValueTipFunction(item, index, series, this.temporaryValue);
            }
