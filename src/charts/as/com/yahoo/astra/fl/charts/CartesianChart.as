package com.yahoo.astra.fl.charts
{
    ...
    //--------------------------------------
         ...
         * @inheritDoc
         */
        public function calcItemToPosition(series:ISeries, itemIndex:int):Object
        {
            var point:Object = {};
        ...
        {
            var point:Object = this.calcItemToPosition(series, itemIndex);
        ...
        {
            var results:Object = super.getInfo();

            if (this._contentBounds != null && this._contentBounds is Rectangle) {
                results.contentBounds = {
                    x: (this.contentBounds as Rectangle).x,
                    y: (this.contentBounds as Rectangle).y,
                    seriesWidth: (this.contentBounds as Rectangle).width,
                    seriesHeight: (this.contentBounds as Rectangle).height
                }
            }
    ...
    //--------------------------------------
         ...
         */
        override protected function defaultDataTipFunction(item:Object, index:int, series:ISeries, value:Number=0):String
        {
        ...
        protected function calculateContentBounds():void
        {
            ...
            if(this.verticalAxis.title != null)
            {
                ...
                verticalAxisTitleDistance = this.getStyleValue("verticalAxisTitleDistance") as Number;
            }

            if(this.horizontalAxis.title != null)
            {
                horizontalTitleHeight = TextUtil.getTextHeight(this.horizontalAxis.title, this.getStyleValue("horizontalAxisTitleTextFormat") as TextFormat, this.getStyleValue("horizontalAxisTitleRotation") as Number);
                horizontalAxisTitleDistance = this.getStyleValue("horizontalAxisTitleDistance") as Number;
            }
