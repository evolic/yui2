package com.yahoo.astra.fl.charts.events
{
    ...
    //--------------------------------------
        ...
        /**
         * Defines the value of the <code>type</code> property of an <code>itemRollOver</code> event object.
         *
        ...
        /**
         * Defines the value of the <code>type</code> property of an <code>itemRollOut</code> event object.
         *
        ...
        /**
         * Defines the value of the <code>type</code> property of an <code>itemClick</code> event object.
         *
         * @eventType itemClick
         */
        ...
        /**
         * Defines the value of the <code>type</code> property of an <code>itemDoubleClick</code> event object.
         *
        ...
        /**
         * Defines the value of the <code>type</code> property of an <code>itemDDStart</code> event object.
         *
         * @eventType itemDDStart
         */
        public static const ITEM_DD_START:String = "itemDDStart";

        /**
         * Defines the value of the <code>type</code> property of an <code>itemDD</code> event object.
         *
         * @eventType itemDD
         */
        public static const ITEM_DD:String = "itemDD";

        /**
         * Defines the value of the <code>type</code> property of an <code>itemDDEnd</code> event object.
         *
         * @eventType itemDDEnd
         */
        public static const ITEM_DD_END:String = "itemDDEnd";
